...
test_paths_metrics_dataset_types_save_pred: dict[str, tuple[str, str, bool]] = {
    ...
    f"{DATA_PATH}/Multiplication_binary_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Multiplication_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Division_binary_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Division_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Exponentiation_binary_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    ...
    f"{DATA_PATH}/Mean_binary_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Mean_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
    f"{DATA_PATH}/Std_binary_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt", True),
